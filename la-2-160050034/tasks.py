...
def taskSquare(draw):
	...
	nn1 = nn.NeuralNetwork(2, 0.1, 2, 10)
...
def taskCifar10():	
	...
	# nn1 = nn.NeuralNetwork(10, 0.1, 10, 20)
	# nn1.addLayer(AvgPoolingLayer([3,32,32],[8,8],8))
	# nn1.addLayer(ConvolutionLayer([3,4,4], [2,2], 32, 2))
	# nn1.addLayer(FlattenLayer())
	# nn1.addLayer(FullyConnectedLayer(128,10))

	nn1 = nn.NeuralNetwork(10, 0.1, 10, 20)
	nn1.addLayer(AvgPoolingLayer([3,32,32],[8,8],8))
	nn1.addLayer(ConvolutionLayer([3,4,4], [2,2], 15, 2))
	nn1.addLayer(FlattenLayer())
